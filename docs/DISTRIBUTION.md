...
| Pages 固定数据 ZIP（v0.12） | 80,459,434 | 76.7 MiB |
| Pages 解包数据（v0.12） | 146,251,850 | 139.5 MiB |
| npm/jsDelivr 高频数据（解包） | 7,379,104 | 7.0 MiB |
| npm 高频数据 tarball | 1,809,696 | 1.7 MiB |
